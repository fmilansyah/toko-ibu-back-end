...
$api = array(
    ...
    "DB_SERVER" => "localhost", // db server
    "WEB_SERVER" => "https://maudhio.000webhostapp.com/", // web server
    "DIR_API_LOCAL" => "/hasil", // directori API Local
    "DIR_API_PRO" => "/api", // directori API Production
    "DIR_API" => "api", // directori API Production
    "PATH_FRONTEND" => "/dhammawangsaDevsssssss/#/", 
);
