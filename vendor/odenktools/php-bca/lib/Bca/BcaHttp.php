...
class BcaHttp
{
    ...
    {
        // Required parameters.
        $this->settings['corp_id'] = "BCAAPI2016";
        $this->settings['client_id'] = "6eaf0f0f-8cce-4783-b7b1-dc7be52d7cfe";
        $this->settings['client_secret'] = "38bce529-9f6b-4c5e-bf43-7092072571a3";
        $this->settings['api_key'] = "5e97ec74-79e3-42ae-a117-bdd35b1d26b7";
        $this->settings['secret_key'] = "7745d3c2-1438-4145-a8e5-8f62e609d098";
        $this->settings['host'] =
    ...
    public function generateVirtualAccount($oauth_token, $companyCode, $requestID)
    {
        $corp_id = $this->settings['corp_id'];

        $uriSign = "GET:/va/payments?CompanyCode=$companyCode&RequestID=$requestID";
        $isoTime = self::generateIsoTime();
        $authSignature = self::generateSign($uriSign, $oauth_token, $this->settings['secret_key'], $isoTime, null);
        ...
        $request_path = "va/payments?CompanyCode=$companyCode&RequestID=$requestID";
        $domain = $this->ddnDomain();
        $full_url = $domain . $request_path;
